    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-orange-50/30 to-background">
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="font-serif font-bold text-3xl md:text-4xl text-foreground">Create New Quiz</h1>
            <p className="text-muted-foreground text-lg">Set up a new quiz for your students</p>
          </div>
        </div>
